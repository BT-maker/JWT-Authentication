// Spring Security için kullanıcı detaylarını tutan sınıf
...
public class UserDetailsImpl implements UserDetails {
    ...
    private Collection<? extends GrantedAuthority> authorities; // Kullanıcı rolleri
    ...
    // User entity'den UserDetailsImpl nesnesi oluşturur
